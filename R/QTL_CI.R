...
#' 4) inferior marker or inbetween position names; 5) inferior positions in cM;
#' 6) superior marker or inbetween position names; 7) superior positions in cM;
#' 8) ranges in cM.}
#' 
